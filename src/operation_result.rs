...
impl InnerOperationResult {
    pub fn from_xdr(x: &xdr::OperationResultTr) -> Result<InnerOperationResult> {
        match x {
            ...
            xdr::OperationResultTr::ClaimClaimableBalance(xdr_inner) => {
                Ok(InnerOperationResult::ClaimClaimableBalance(xdr_inner.clone()))
            }
            xdr::OperationResultTr::BeginSponsoringFutureReserves(xdr_inner) => {
                Ok(InnerOperationResult::BeginSponsoringFutureReserves(xdr_inner.clone()))
            }
            xdr::OperationResultTr::EndSponsoringFutureReserves(xdr_inner) => {
                Ok(InnerOperationResult::EndSponsoringFutureReserves(xdr_inner.clone()))
            }
            ...
            xdr::OperationResultTr::ClawbackClaimableBalance(xdr_inner) => {
                Ok(InnerOperationResult::ClawbackClaimableBalance(xdr_inner.clone()))
            }
            xdr::OperationResultTr::SetTrustLineFlags(xdr_inner) => {
                Ok(InnerOperationResult::SetTrustLineFlags(xdr_inner.clone()))
            }
            xdr::OperationResultTr::LiquidityPoolDeposit(xdr_inner) => {
                Ok(InnerOperationResult::LiquidityPoolDeposit(xdr_inner.clone()))
            }
            xdr::OperationResultTr::LiquidityPoolWithdraw(xdr_inner) => {
                Ok(InnerOperationResult::LiquidityPoolWithdraw(xdr_inner.clone()))
            }
...
impl PathPaymentStrictReceiveResult {
    pub fn from_xdr(
        ...
        match *x {
            ...
            xdr::PathPaymentStrictReceiveResult::NoIssuer(
                ref xdr_asset,
            ) => {
...
impl PathPaymentStrictSendResult {
    pub fn from_xdr(x: &xdr::PathPaymentStrictSendResult) -> Result<PathPaymentStrictSendResult> {
        match *x {
            ...
            xdr::PathPaymentStrictSendResult::NoTrust => {
            ...
            xdr::PathPaymentStrictSendResult::LineFull => {
...
impl ManageSellOfferResult {
    pub fn from_xdr(x: &xdr::ManageSellOfferResult) -> Result<ManageSellOfferResult> {
        match *x {
            ...
            xdr::ManageSellOfferResult::Malformed => {
                Ok(ManageSellOfferResult::Malformed)
            }
            xdr::ManageSellOfferResult::SellNoTrust => {
                Ok(ManageSellOfferResult::SellNoTrust)
            }
            xdr::ManageSellOfferResult::BuyNoTrust => {
            ...
            xdr::ManageSellOfferResult::LineFull => {
                Ok(ManageSellOfferResult::LineFull)
            }
            xdr::ManageSellOfferResult::Underfunded => {
                Ok(ManageSellOfferResult::Underfunded)
            }
            xdr::ManageSellOfferResult::CrossSelf => {
                Ok(ManageSellOfferResult::CrossSelf)
            }
            xdr::ManageSellOfferResult::SellNoIssuer => {
                Ok(ManageSellOfferResult::SellNoIssuer)
            }
            xdr::ManageSellOfferResult::BuyNoIssuer => {
                Ok(ManageSellOfferResult::BuyNoIssuer)
            }
            xdr::ManageSellOfferResult::NotFound => {
...
impl ManageBuyOfferResult {
    pub fn from_xdr(x: &xdr::ManageBuyOfferResult) -> Result<ManageBuyOfferResult> {
        match *x {
            ...
            xdr::ManageBuyOfferResult::Malformed => {
                Ok(ManageBuyOfferResult::Malformed)
            }
            xdr::ManageBuyOfferResult::SellNoTrust => {
                Ok(ManageBuyOfferResult::SellNoTrust)
            }
            xdr::ManageBuyOfferResult::BuyNoTrust => {
            ...
            xdr::ManageBuyOfferResult::LineFull => {
                Ok(ManageBuyOfferResult::LineFull)
            }
            xdr::ManageBuyOfferResult::Underfunded => {
                Ok(ManageBuyOfferResult::Underfunded)
            }
            xdr::ManageBuyOfferResult::CrossSelf => {
                Ok(ManageBuyOfferResult::CrossSelf)
            }
            xdr::ManageBuyOfferResult::BuyNoIssuer => {
                Ok(ManageBuyOfferResult::BuyNoIssuer)
            }
            xdr::ManageBuyOfferResult::SellNoIssuer => {
                Ok(ManageBuyOfferResult::SellNoIssuer)
            }
            xdr::ManageBuyOfferResult::NotFound => {
                Ok(ManageBuyOfferResult::NotFound)
            }
            xdr::ManageBuyOfferResult::LowReserve => {
...
impl AccountMergeResult {
    pub fn from_xdr(x: &xdr::AccountMergeResult) -> Result<AccountMergeResult> {
        match *x {
            ...
            xdr::AccountMergeResult::ImmutableSet => {
                Ok(AccountMergeResult::ImmutableSet)
            }
            xdr::AccountMergeResult::HasSubEntries => {
                Ok(AccountMergeResult::HasSubEntries)
            }
            xdr::AccountMergeResult::SeqnumTooFar => {
                Ok(AccountMergeResult::SequenceTooFar)
            }
            xdr::AccountMergeResult::DestFull => {
...
impl CreateClaimableBalanceResult {
    pub fn from_xdr(x: &xdr::CreateClaimableBalanceResult) -> Result<CreateClaimableBalanceResult> {
        match *x {
            ...
            xdr::CreateClaimableBalanceResult::NoTrust => {
